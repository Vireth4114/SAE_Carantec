...
<div id='safetySheet'>
    <table id='firstTable' class='bold'>
        ...
        <tr>
            ...
            <td colspan='2' rowspan='4'><img id='logoSafetySheet' src='https://dev-sae301grp5.users.info.unicaen.fr/images/logoSafetySheet.png' alt='carantec nautism' width='600px'></td>
        </tr>
        <tr>
